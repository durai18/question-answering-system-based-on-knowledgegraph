...
def generate_graph(model):
    with open(f"E:/rawkg/Knowledge-Graph-for-Quant-Finance-main/Ontology/StanfordOpenIE/FINAL/stanfordOpenIE_allfilters.json") as f:
        triplets = json.load(f)

    with open(f'E:/rawkg/Knowledge-Graph-for-Quant-Finance-main/Ontology/StanfordOpenIE/FINAL/stanfordopenie_ontology.json') as f:
        allKeys = json.load(f)
...
if __name__ == "__main__":
    ...
    st.subheader("Jerusalem College of Engineering")
    st.title("Knowledge Graph for Research Articles")
    st.write("----")
    ...
    if model_name:
        ...
        text_input = st.text_input(
            "Enter some text 👇", placeholder="What did girsih do?", key="text_input")
        if text_input:
